...
function HomePage() {
  ...
  return (
    <div className="flex h-screen flex-col p-8">
      ...
      <div className="my-auto flex justify-center items-center relative mb-0">
        <button
      ...
      <div className="my-auto flex flex-col gap-4">
        ...
        <Input type="number" pattern="\d*" placeholder="年齡" onChange={(e) => {
          setUserInfo((prev) => ({
            ...prev,
            age: parseInt(e.target.value)
          }))
        }} />
        <Select defaultValue="zh" onValueChange={(e) => {
          setUserInfo((prev) => ({
            ...prev,
            lang: e
          })) 
      ...
      <Button asChild variant="secondary" size="lg">
        <Link to="/map" className="w-full" onClick={
          () => {
            mutateAsync({
              name: user?.realName || '',
              age: userInfo.age,
